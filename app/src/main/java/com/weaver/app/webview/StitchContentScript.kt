...
internal object StitchContentScript {
    ...
    val source: String = buildString {
        ...
        append("case 'clear_selection':{document.querySelectorAll('[data-design-node][data-selected=\"true\"]').forEach(function(el){el.dispatchEvent(new MouseEvent('click',{bubbles:true,shiftKey:false}));});var body=document.body;body.dispatchEvent(new MouseEvent('click',{bubbles:true,clientX:1,clientY:1}));break;}")
